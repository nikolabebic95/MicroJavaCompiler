...
public class FormalParamListDerived1 extends FormalParamList {

    private FormalParamList FormalParamList;
    private FormalParamDecl FormalParamDecl;

    public FormalParamListDerived1 (FormalParamList FormalParamList, FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormalParamListDerived1(\n");
