...
public class PredefinedFunctionDerived3 extends PredefinedFunction {

    private RightValue RightValue;

    public PredefinedFunctionDerived3 (RightValue RightValue) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("PredefinedFunctionDerived3(\n");
