...
public class FormalParametersListNonEmptyDerived3 extends FormalParametersListNonEmpty {

    private FormalParameter FormalParameter;

    public FormalParametersListNonEmptyDerived3 (FormalParameter FormalParameter) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormalParametersListNonEmptyDerived3(\n");
