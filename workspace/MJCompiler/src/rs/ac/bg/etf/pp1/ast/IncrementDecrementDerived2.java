...
public class IncrementDecrementDerived2 extends IncrementDecrement {

    private LeftValue LeftValue;

    public IncrementDecrementDerived2 (LeftValue LeftValue) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("IncrementDecrementDerived2(\n");
