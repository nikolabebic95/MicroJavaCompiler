...
public class ActualParamListDerived1 extends ActualParamList {

    private ActualParamList ActualParamList;
    private Expr Expr;

    public ActualParamListDerived1 (ActualParamList ActualParamList, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ActualParamListDerived1(\n");
