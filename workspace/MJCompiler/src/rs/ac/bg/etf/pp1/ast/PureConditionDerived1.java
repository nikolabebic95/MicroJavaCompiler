...
public class PureConditionDerived1 extends PureCondition {

    private ConditionTerm ConditionTerm;
    private OptionalConditionTerms OptionalConditionTerms;

    public PureConditionDerived1 (ConditionTerm ConditionTerm, OptionalConditionTerms OptionalConditionTerms) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("PureConditionDerived1(\n");
