...
public class FormalParamListDerived2 extends FormalParamList {

    private FormalParamDecl FormalParamDecl;

    public FormalParamListDerived2 (FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormalParamListDerived2(\n");
